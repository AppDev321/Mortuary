...
class DropProcessUnitMapScreen extends StatefulWidget {
  ...
  const DropProcessUnitMapScreen({Key? key, required this.dataModel, required this.deathReportId, required this.deathCaseID}) : super(key: key);

  @override
  State<DropProcessUnitMapScreen> createState() => _DropProcessUnitMapScreenState();
}
        ...
        builder: (controller) {
          return CustomScreenWidget(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, titleText: AppStrings.processCenterLoc.toUpperCase(), children: [
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: GoogleMapViewWidget(
                  ...
                  destinationPoints: LatLng(widget.dataModel.latitude, widget.dataModel.longitude),
                ),
              ),
            ),
            ...
            ButtonWidget(
              ...
              onPressed: () {
                controller.dropBodyToProcessingUnitByTransport(deathReportId: widget.deathReportId,
                    deathCaseId: widget.deathCaseID, processingUnitID: widget.dataModel.processingCenterId);
              },
            ),
            sizeFieldLargePlaceHolder,
          ]);
