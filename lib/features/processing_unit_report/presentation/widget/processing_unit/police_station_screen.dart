...
class _PoliceStationScreenState extends State<PoliceStationScreen> {
    ...
    return GetBuilder<ProcessingUnitController>
      ...
      return Form(
        ...
        child: CustomScreenWidget(
            titleText: AppStrings.policeStation.toUpperCase(),
  ...
  List<int> getCheckedStations(List<CheckedBoxItem> checkedBoxItems) {
    return checkedBoxItems
        .where((checkedBoxItem) => checkedBoxItem.isChecked)
        .map((checkedBoxItem) => checkedBoxItem.stationPoc.id)
        .toList();
  }
}
